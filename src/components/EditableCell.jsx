...
const EditableCell = ({
    ...
    return (
      ...
      <div className="flex items-center space-x-2 min-w-0 ">
        <input
          ...
          type={type}
          className={`flex-1 px-3 py-2 border-2 rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 text-sm `}
  ...
  return (
    <div className="relative px-3 py-3 cursor-pointer hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 rounded-lg transition-all duration-300 group border border-transparent hover:border-indigo-200 hover:shadow-sm">
      ...
      >
        <span
          className="group-hover:text-indigo-700 transition-colors duration-300 font-medium   "
          onClick={() => onEdit(rowId, filed)}
        >
          {formatValue(value)}
        </span>
